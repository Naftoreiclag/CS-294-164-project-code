...
def main():
    ...
    videos = [
        ('test1', 'test_data/20160R_V006.avi', 'test_data/20160R_V006_Reference.png', range(0, 300))
    ]
    ...
    for video_debug_name, video_fname, reference_frame_fname, frame_range in videos:
        ...
        for sensor_name, sensor_class in sensors:
            ...
            def export_data(sensor_match_locs, sensor_extra_data):
                # Export data
            ...
            for frame_idx in frame_range:
                ...
                for strip_idx_in_frame in range(strip_count):
                    ...
                    if result is None:
                        result = (None, {})
                    sensor_match_loc, sensor_extra = result
                ...
                if frame_idx % 20 == 0:
                    # Save checkpoint
                    export_data(sensor_match_locs, sensor_extra_data)
